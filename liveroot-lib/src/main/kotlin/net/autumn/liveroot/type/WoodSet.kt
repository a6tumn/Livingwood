    ...
    init {
        ...
        enabledBlocks.forEach { type ->
            when (type) {
                ...
                BlockType.STAIRS -> {
                    check(planks != null) { "Planks should exist" }
